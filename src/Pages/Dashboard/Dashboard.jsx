        ...
        <div className="flex ">
            <div className="w-64 min-h-screen bg-black">
                <div className="avatar flex flex-col gap-5 items-center justify-center mt-10 md:mt-24">
                    ...
                    <ul className="bg-purple-500 rounded-lg w-28 md:w-56 text-black space-y-2 md:space-y-4 py-2 md:px-4 mb-5">
                    <li><NavLink className='flex items-center gap-3' to='/dashboard/dashboardHome'>
                            <MdTask className="text-2xl"/>
                            <p className="text-xl md:text-2xl">User Home</p>
                        </NavLink></li>
                        <hr />
                        <li><NavLink className='flex items-center gap-3' to='/dashboard/addTask'>
                            <MdTask className="text-2xl"/>
                            <p className="text-xl md:text-2xl">Add Task</p>
                        </NavLink></li>
                    </ul>
                </div>
                <hr />
